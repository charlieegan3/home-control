...
(function(root, factory) {
  ...
  return (function() {
    ...
    function getAttributeValueWithDisinheritance(initialElement, ancestor, attributeName) {
      ...
      if (
        initialElement !== ancestor && disinherit
    ...
    function matches(elt, selector) {
      ...
      var matchesFunction = elt.matches || elt.matchesSelector || elt.msMatchesSelector || elt.mozMatchesSelector
      ...
      if (tokens[0] === "[") {
        ...
        while (tokens.length > 0) {
          ...
          if (isPossibleRelativeReference(token, last, paramName)) {
            conditionalSource += "((" + paramName + "." + token + ") ? (" + paramName + "." + token + ") : (window."
              + token + "))";
          } else {
    ...
    function ignoreBoostedAnchorCtrlClick(elt, evt) {
      return getInternalData(elt).boosted && elt.tagName === "A" && evt.type === "click"
    ...
    function evalScript(script) {
      if (
        !script.htmxExecuted && htmx.config.allowScriptTags
    ...
    function findElementsToProcess(elt) {
      if (elt.querySelectorAll) {
        ...
        var results = elt.querySelectorAll(
          VERB_SELECTOR + boostedSelector + ", form, [type='submit'], [hx-sse], [data-hx-sse], [hx-ws],"
    ...
    function shouldInclude(elt) {
      ...
      if (
        elt.type === "button" || elt.type === "submit" || elt.tagName === "image" || elt.tagName === "reset"
        || elt.tagName === "file"
      ) {
        return false;
      }
      ...
      if (htmx.config.includeIndicatorStyles !== false) {
        getDocument().head.insertAdjacentHTML(
          ...
          "<style>\
                      ...
                      ." + htmx.config.requestClass + " ." + htmx.config.indicatorClass
